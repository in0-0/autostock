...
description: v0.2는 Google Sheets 기반 후보 검토 MVP이며 주문, 수량 산정, 목표 비중 추천, 실증권사 API 연결은 범위 밖으로 둔 릴리즈 후보 상태다.
...
v0.2.0-rc.1은 정리됐지만 정식 v0.2 릴리스 태그와 배포 승인은 아직 기록되어 있지 않다.
