...
2026-06-16 KST v0.2.0-rc.1 QA에서는 `python3 -m pytest` 79개 테스트, sample/mock CLI smoke, runtime artifact 구조 확인, `data/` 안전 스캔이 통과했다. 실제 Google Sheets live read와 Telegram test chat send는 credential이 필요한 P1 운영 smoke로 남아 있다.
